...
> ⚠️ **Запомните:** 
> Преимущество Сета – моментальная проверка наличия элемента, только уникальные элементы
...
4. Представь, что есть [группа в телеграмме ](t.me/swift_learning), в которую может вступить пользователь, у этой группы есть список участников. 
