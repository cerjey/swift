...
let set: Set<String> = ["🍎", "🍌", "🍎"]  // Множество: ["🍎", "🍌"] (дубликат удален)
```
...
> ⚠️ **Запомните:** Преимущество Сета – моментальная проверка наличия элемента
...
> ⚠️ **Запомните:** Преимущество Сета – хранятся только уникальные элементы
> 
---
