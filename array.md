...
* ➕ Добавление, удаление и поиск индексов
* 🎭 Как всё же хранить элементы разных типов ?
...
В Swift такой список называется **массивом**. 

Это просто **пронумерованный список**, где у каждого элемента есть свой порядковый номер (индекс).
