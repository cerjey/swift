...
<br>
✅ **Ответ: 4** — последний элемент всегда имеет индекс `array.count - 1`
<br><br>
</details>
...
<br>
💥 **Ответ: Программа упадет с ошибкой** — обращение по несуществующему индексу вызывает fatal error
<br><br>
</details>
...
<br>
🔢 **Ответ: 3** — было 5 элементов, удалили один по индексу (осталось 4), удалили первый (осталось 3)
<br><br>
</details>
...
<br>
🔄 **Ответ: `sort()` меняет массив, `sorted()` создает новый** — важное различие!
<br><br>
</details>
...
<br>
🔍 **Ответ: 1** — firstIndex возвращает индекс ПЕРВОГО вхождения
<br><br>
</details>

<details>
<summary><b>Вопрос 6: Как безопасно получить последний элемент массива?</b></summary>

<br>
🛡️ **Ответ: `array.last`** — возвращает Optional, безопасно даже для пустого массива
<br><br>
</details>
...
<br>
🎭 **Ответ: Можно, если обернуть в протокол** — это правильный архитектурный подход
<br><br>
</details>
...
<br>
🧮 **Ответ: [2, 4]** — filter оставляет только четные числа
<br><br>
</details>
...
<br>
📭 **Ответ: nil** — first для пустого массива возвращает nil
<br><br>
</details>

<details>
<summary><b>Вопрос 10: Как добавить элемент в начало массива?</b></summary>

<br>
⬅️ **Ответ: `array.insert(0, at: 0)`** — insert с индексом 0 добавляет в начало
<br><br>
</details>
