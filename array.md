...
<summary><b>Вопрос 2: Что произойдет при выполнении кода?</b>
...
<summary><b>Вопрос 3: Что выведет этот код?</b>
...
<summary><b>Вопрос 4: Что вернет `[1, 2, 3, 2, 1].firstIndex(of: 2)`?</b></summary>

  

**Ответ: 1** — firstIndex возвращает индекс ПЕРВОГО вхождения (**1**)

</details>

<details>

<summary><b>Вопрос 5: Можно ли хранить в одном массиве `Student` и `Teacher`?</b></summary>
...
<summary><b>Вопрос 6: Что выведет этот код?</b>
...
<summary><b>Вопрос 7: Что произойдет при выполнении?</b>
...
<summary><b>Вопрос 8: Как добавить элемент в начало массива?</b></summary>

  

**Ответ: `array.insert(0, at: 0)`** — insert с индексом 0 добавляет в начало
